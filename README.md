...
| `k8ify.initContainerOf: $name`  | This Compose service will be combined with another Compose service, resulting in a deployment or statefulSet with one or more initContainers. |
